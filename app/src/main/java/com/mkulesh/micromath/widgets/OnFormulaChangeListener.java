...
public interface OnFormulaChangeListener {
    /**
     ...
     */
    void onTermSelection(@Nullable View owner, boolean isSelected, @Nullable ArrayList<View> list);
     ...
     */
    OnFormulaChangeListener onExpandSelection(View owner, ContextMenuHandler handler);
