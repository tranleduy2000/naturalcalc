...
public class Commander extends DialogBase implements CommanderIf {
    ...
    public Commander(Activity context, int nameId, SelectionMode selectionMode, CharSequence[] assetFilter, OnFileSelectedListener listener) {
