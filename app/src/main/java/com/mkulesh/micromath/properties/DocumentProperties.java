...
public class DocumentProperties {
    ...
    public void writeToXml(XmlSerializer serializer) throws Exception {
        final DecimalFormat df = CompatUtils.getDecimalFormat("0.00000");
        serializer.attribute(Constants.XML_NS, XML_PROP_TEXT_WIDTH, String.valueOf(textWidth));
        serializer.attribute(Constants.XML_NS, XML_PROP_SIGNIFICANT_DIGITS, String.valueOf(significantDigits));
        serializer.attribute(Constants.XML_NS, XML_PROP_SCALE, df.format(scaledDimensions.getScaleFactor()));
        serializer.attribute(Constants.XML_NS, XML_PROP_REDEFINE_ALLOWED, String.valueOf(redefineAllowed));
    }
}
