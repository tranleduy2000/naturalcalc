...
public class ResultProperties implements Parcelable {
    ...
    public void writeToXml(XmlSerializer serializer) throws Exception {
        serializer.attribute(Constants.XML_NS, XML_PROP_DISABLE_CALCULATION, String.valueOf(disableCalculation));
        serializer.attribute(Constants.XML_NS, XML_PROP_HIDE_RESULT_FIELD, String.valueOf(hideResultField));
        serializer.attribute(Constants.XML_NS, XML_PROP_ARRAY_LENGTH, String.valueOf(arrayLength));
    }
}
